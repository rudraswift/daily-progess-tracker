  ...
  return (
    <div className="min-h-screen p-6 md:p-10 flex flex-col justify-between bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-slate-800">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10 w-full py-10">
        ...
        {/* Central Card */}
        <div className="bg-white/70 backdrop-blur-2xl p-8 sm:p-10 rounded-[2rem] shadow-[0_8px_40px_rgb(0,0,0,0.06)] border border-white/50 max-w-[420px] w-full mx-auto relative overflow-hidden">
          
          <div className="text-center mb-8">
            <h2 className="text-[28px] font-bold text-slate-900 tracking-tight leading-tight">Welcome back</h2>
            <p className="text-slate-500 mt-2 text-sm font-medium">Continue your journey to productivity.</p>
          </div>
